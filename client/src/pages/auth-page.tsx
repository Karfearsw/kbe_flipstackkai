...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      {/* Left side - Hero section (on desktop) */}
      <div className="flex flex-col p-6 lg:w-1/2 bg-primary text-white items-center justify-center order-first lg:order-first">
        <div className="max-w-lg">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6 font-heading">Streamline Your Real Estate Deals</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="mt-8 p-4 bg-white bg-opacity-10 rounded-lg">
              ...
              <p className="mb-2">Login or create an account to transform your real estate business with Flipstackk.</p>
              <p className="text-xs text-white text-opacity-70">For demonstration purposes, you can use the username "benjistackk" and password "password" to explore the platform.</p>
            </div>
          </div>
        </div>
      </div>
      
      {/* Right side - Auth form (on desktop) */}
      <div className="flex items-center justify-center p-4 lg:w-1/2 order-last lg:order-last">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold font-heading text-neutral-900 mb-2">Flipstackk</h1>
            <p className="text-neutral-600">Real Estate Deal Management Platform</p>
          </div>
